...
let cellWidth = 250; //200
let cellHeight = 200; //200
let offset = 100; //0
...
let BG = [230, 223, 204]; //beige 
//let BG = [255]; //white 
//let BG = [0]; //Black
//let BG = [116,164,102]; //Green
//let BG = [204,164,160] // Oyster Pink
...
function DrawBAU(){
  ...
  // A
beginShape();
vertex(BAUX + 15, BAUY + 60); 
vertex(BAUX + 27, BAUY + 30); 
vertex(BAUX + 39, BAUY + 60); 
vertex(BAUX + 29, BAUY + 60); 
vertex(BAUX + 27, BAUY + 56); 
vertex(BAUX + 25, BAUY + 60); 
endShape(CLOSE);
  // U
  fill(black);
...
rect(HAUSX + 76, HAUSY + 20, 6, 6);
  // A
 beginShape();
vertex(HAUSX + 90 , HAUSY + 40);   
vertex(HAUSX + 102, HAUSY + 10); 
vertex(HAUSX + 114, HAUSY + 40);  
vertex(HAUSX + 104, HAUSY + 40);  
vertex(HAUSX + 102, HAUSY + 36);  
vertex(HAUSX + 100, HAUSY + 40);  
endShape(CLOSE);
  // U
fill(black);
